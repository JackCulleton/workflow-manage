...
export function addPhase(state, input) {
  ...
  const phase = { id: uid(), name, description: (input.description || '').trim(), projects: [], topics: [], documents: [] };
  state.phases.push(phase);
  state.curriculum.phases.push({ id: phase.id, name: phase.name, description: phase.description, projects: [], topics: [] });
